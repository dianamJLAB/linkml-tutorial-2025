...
linkml_meta = LinkMLMeta({'default_prefix': 'dmlinkml',
     ...
     'prefixes': {'PATO': {'prefix_prefix': 'PATO',
                  ...
                  'dmlinkml': {'prefix_prefix': 'dmlinkml',
                               'prefix_reference': 'https://w3id.org/dianamJLAB/linkml-tutorial-2025/'},
     ...
     'see_also': ['https://dianamJLAB.github.io/linkml-tutorial-2025'],
     'source_file': 'src/dmlinkml/schema/dmlinkml.yaml',
...
class NamedThing(ConfiguredBaseModel):
    ...
    linkml_meta: ClassVar[LinkMLMeta] = LinkMLMeta({'class_uri': 'schema:Thing',
         'from_schema': 'https://w3id.org/dianamJLAB/linkml-tutorial-2025'})
...
class Person(NamedThing):
    ...
    Represents a Person
    """
    linkml_meta: ClassVar[LinkMLMeta] = LinkMLMeta({'from_schema': 'https://w3id.org/dianamJLAB/linkml-tutorial-2025',
